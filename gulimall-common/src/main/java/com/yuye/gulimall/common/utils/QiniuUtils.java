...
//...其他参数参考类注释
        UploadManager uploadManager = new UploadManager(cfg);
//...生成上传凭证，然后准备上传
        String accessKey = "TkNCiKMBWxvZdXYQNeN0MZMOzfuLBxqr2-evWqHs";
        String secretKey = "-mpC27OnqB3mY67EmGDmqI8yrtM-NHnRxFy_qVAo";
        String bucket = "yuye-gulimall";
//默认不指定key的情况下，以文件内容的hash值作为文件名
        String key = UUID.randomUUID().toString()+".png";
        FileInputStream fileInputStream = null;
        try {

            String filePath = "G:\\BaiduNetdiskDownload\\谷粒商城\\Guli Mall(包含代码、课件、sql)\\Guli Mall\\分布式基础\\资源\\pics\\huawei.png";
...
//            byte[] uploadBytes = "hello qiniu cloud".getBytes("utf-8");
    ...
    private static void getdownloadurl() throws UnsupportedEncodingException {
        ...
        String domainOfBucket = "http://rcxmzaoq4.hn-bkt.clouddn.com";
